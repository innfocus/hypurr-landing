...
export const TOKEN_ABI = [
	{
		inputs: [
			...
			{ internalType: 'address', name: '_posm', type: 'address' },
			{ internalType: 'address', name: '_permit2', type: 'address' },
			{ internalType: 'address payable', name: '_router', type: 'address' },
		],
	...
	{ inputs: [], name: 'NoPunksBoughtYet', type: 'error' },
	{ inputs: [], name: 'NoSaleToProcess', type: 'error' },
	...
	{ inputs: [], name: 'PunkNotForSale', type: 'error' },
	{ inputs: [], name: 'PunkNotOwned', type: 'error' },
	...
	{
		anonymous: false,
		inputs: [{ indexed: false, internalType: 'uint256', name: 'ethFees', type: 'uint256' }],
		name: 'ProtocolFeesFromSales',
		type: 'event',
	},
	{
		anonymous: false,
	...
	{ inputs: [], name: 'addFees', outputs: [], stateMutability: 'payable', type: 'function' },
	{
		inputs: [
